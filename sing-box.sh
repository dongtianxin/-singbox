...
E[80]="subscribe"
C[80]="订阅"
E[81]="Adaptive Clash / V2rayN / NekoBox / ShadowRocket / SFI / SFM Clients"
C[81]="自适应 Clash / V2rayN / NekoBox / ShadowRocket / SFI / SFM 客户端"
...
http {
  map \$http_user_agent \$path {
    ...
    ~*SFI                     /sing-box-phone; # 匹配 Sing-box phone 客户端
